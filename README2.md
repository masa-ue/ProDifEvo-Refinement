...
CUDA_VISIBLE_DEVICES=7 python refinement_initial.py  --specify 1 --decoding GA  --repeatnum 50 --duplicate 20  --metrics_name globularity,plddt  --metrics_list 1,1 --iteration 250
